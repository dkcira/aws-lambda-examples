...
This is a sample template for default-example - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name default-example --tail
```
...
```bash
aws cloudformation delete-stack --stack-name default-example
```
